...
for f in cttel-store.php cttel-customizer.php cttel-quick-categories.php cttel-product-cards.php cttel-wc-rest-automation.php cttel-used-phone-divar.php; do
  [ -f "${ROOT}/mu-plugins/${f}" ] && \
