...
- **درصد تعمیرکار**: سهم از اجرت + سهم از سود قطعه (مثلاً ۳۰٪)
...
- **دسترسی پرسنل**: نقش‌های پذیرش، حسابدار، کامل، و مدیر
- **مدیریت (فقط مدیر)**: پرسنل، تعمیرکاران، قطعه‌فروش
...
| `/staff` | لیست پرسنل (مدیر) |
| ⚙️ مدیریت | منوی مدیر: پرسنل، تعمیرکار، فروشنده |

### نقش‌های پرسنل

| نقش | دسترسی |
|---|---|
| مدیر | همه بخش‌ها + ⚙️ مدیریت |
| پذیرش + حسابداری | منوی پذیرش و حسابداری |
| حسابدار | فقط حسابداری |
| پذیرش | فقط پذیرش |

کاربران غیرپرسنل پیام «⛔️ فقط پرسنل مجاز...» دریافت می‌کنند. `/myid` برای گرفتن آیدی.
