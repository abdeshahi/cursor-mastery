...
class ExportService:
    def __init__(self, repo: RepairRepository, export_dir: Path) -> None:
        self.repo = repo
    ...
    async def export_accounting_pdf(self) -> Path:
        ...
        return build_accounting_pdf(dashboard, repairs, customer_debts, path)
    ...
    async def export_invoice_pdf(self, repair_id: int) -> Path | None:
        ...
        return build_invoice_pdf(repair, path)
